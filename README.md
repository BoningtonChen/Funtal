...
## Version
Haven't got a RELEASE Version yet.\
Call it VERSION 0.1 for now(maybe).\
Come and join me. :)

## LICENSE
Funtal uses Apache 2.0 LICENSE.

## Description
An Engine Project called "Funtal", built by Bonington Chen.\
Using C++, C, CMAKE, Lua.
...
The Project is still on an early-state of development, a lot of functions haven't been implemented yet, so it may cause you some troubles, sorry! \
